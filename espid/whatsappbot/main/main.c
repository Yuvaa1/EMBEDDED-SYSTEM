...
char api_key[] = "3085366";
char whatsapp_num[] = "916383883654";
char whatsapp_message[] = "Holaa! How are you doing?";
...
static void send_whatsapp_message(void *pvParameters)
{
    ...
    char URL[strlen(callmebot_url) + strlen(whatsapp_num) + strlen(url_encode(whatsapp_message)) + strlen(api_key)];
