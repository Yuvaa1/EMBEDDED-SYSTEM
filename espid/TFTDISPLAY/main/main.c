...
static void example_lvgl_flush_cb(lv_fs_drv_t *drv, const lv_area_t *area, lv_color_t *color_map);
...
void app_main(void)
{
    ...
    disp_drv.user_data = panel_handle; // Add your panel_handle obtained from the display initialization
    lv_disp_t *disp = lv_fs_drv_register(&disp_drv);
